...
const Modal: React.FC<ModalProps> = ({isOpen, onButtonClick}) => {
  if (isOpen) {
    return (
      <div className={styles.modal__overlay }>
        <div className={styles.modal__window}>
          <div className={styles.modal__midlePart}>
          ...
          <div className={styles.modal__bottomPart}>
            <button className="button" onClick={onButtonClick}>Вернуться на главную страницу</button>
          </div>
        </div>
      </div>
    )
